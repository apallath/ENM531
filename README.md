...
- A Python 3.7 enviroment set up for scientific computing (I recommend the [Anaconda distribution](https://anaconda.org/anaconda/python))
...
TA: Yibo Yang,  Office Hours: Tuesdays, 6:00-7:00pm (PICS 534), Fridays, 10.30am-12pm (PICS 534), 3401 Walnut Street, Email: <ybyang@seas.upenn.edu>
